            ...
            <div class="login-box card">
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div class="ms-auto">
                                        <a href="javascript:void(0)" id="to-recover" class="text-muted"><i class="fas fa-lock m-r-5"></i> ¿Olvidadaste tu contraseña?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal" id="recoverform" action="index.html">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Correo electrónico" id="mail">
                                <div id="response"></div>
                            </div>
                        </div>
